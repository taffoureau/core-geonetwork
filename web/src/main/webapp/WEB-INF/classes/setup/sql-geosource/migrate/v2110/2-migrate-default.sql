...
-- DROP CSW settings now in CSW config table
DELETE FROM Settings WHERE id in (123, 124, 125, 126, 127, 128, 129, 130, 140, 141, 150, 151, 152, 153, 154, 155, 160, 161, 162, 163); 
...
-- Was 231 in GN, in mon geosource 216
UPDATE Settings SET name = 'system/xlinkResolver/enable', datatype = 2 WHERE id = 216;
...
DELETE FROM Settings WHERE id = 215;
