...
ALTER TABLE CategoriesDes MODIFY label varchar(255);

ALTER TABLE Languages ADD isocode varchar(3);

ALTER TABLE Metadata MODIFY createDate varchar(30);
ALTER TABLE Metadata MODIFY changeDate varchar(30);
ALTER TABLE Metadata ADD doctype varchar(255);

ALTER TABLE Settings MODIFY value varchar(4000);
